...
//             <div className="relative w-full max-w-md rounded-2xl border border-slate-800 bg-[#0f172a] p-8 shadow-2xl animate-in fade-in zoom-in duration-200">
...
//                     Get deep-dives into LLMs, Cloud Native Architecture, and MLOps directly in your inbox.
//                 </p>

//                 <form 
//                     action="https://api.hashnode.com/newsletter/subscribe" 
//                     method="post" 
...
//                         required 
//                         className="w-full rounded-lg border border-slate-700 bg-slate-800/50 px-4 py-3 text-white placeholder-slate-500 focus:border-[#38bdf8] focus:ring-1 focus:ring-[#38bdf8] outline-none transition-all"
//                     />
//                     <button 
//                         type="submit" 
//                         className="w-full rounded-lg bg-[#38bdf8] py-3 font-bold text-[#020617] hover:bg-white transition-colors"
//                     >
//                         Subscribe
//                     </button>
//                 </form>
