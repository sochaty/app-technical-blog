...
const Post = ({ publication, post }: PostProps) => {
	...
	// 1. ADD THIS GUARD: Prevent rendering if post is missing
	if (!post) return null;
	...
	return (
		<>
			<Head>
				{/* 2. USE OPTIONAL CHAINING: To safely access post properties */}
				<title>{post?.seo?.title || post?.title || 'Technical Insight'}</title>
				<style dangerouslySetInnerHTML={{ __html: highlightJsMonokaiTheme }}></style>
				{/* REMOVE this div from Head: Head should only contain meta/title/style/script tags */}
			</Head>
